...
function Base({ r = 0.1 }: { r?: number }) {
  return (
    <mesh position={[0, 0.02, 0]} castShadow receiveShadow>
      ...
      <meshStandardMaterial color={HULL_DARK} roughness={0.45} metalness={0.6} />
    </mesh>
  );
}
  ...
  return (
    <>
      ...
      <mesh position={[0, 0.2, 0]} castShadow>
        ...
        <meshStandardMaterial color={HULL} roughness={0.35} metalness={0.7} />
      </mesh>
...
function ChartBeacon({ accent }: { accent: string }) {
  ...
  return (
    <>
      <Base r={0.11} />
      {bars.map((h, i) => (
        <mesh key={i} position={[-0.075 + i * 0.05, 0.04 + h / 2, 0]} castShadow>
  ...
  return (
    <>
      ...
      <mesh position={[0, 0.12, 0]} castShadow>
        ...
        <meshStandardMaterial color={HULL} roughness={0.45} metalness={0.5} />
      </mesh>
